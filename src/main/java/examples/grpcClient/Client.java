...
public class Client {
    ...
    public void findServer(String name) {
        ...
        try {
            ...
            uri = response.getConnection().getUri();
            discoveryPort = response.getConnection().getDiscoveryPort();
            port = response.getConnection().getPort();
            protocol = response.getConnection().getProtocol();
            serviceName = response.getConnection().getName();
        } catch (Exception e) {
            System.err.println("RPC failed: " + e);
            return;
        }
    ...
    public void findServers(String name) {
        ...
        try {
            ...
            System.out.println(response.toString());
            response.getConnectionsList().addAll(connections);
        } catch (Exception e) {
            System.err.println("RPC failed: " + e);
            return;
        }
                ...
                while (true) {
                    ...
                    switch (service){
                        ...
                        case "services.Joke/getJoke":
                            ...
                            client.askForJokes(Integer.parseInt(input));
                            break;
